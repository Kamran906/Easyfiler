...
const FriendlyBusiness = () => {
  ...
  const [categories, setCategories] = useState('Friendly Business')
        ...
        <View style={Style.rsinput}>
          ...
          <TextInput style={Style.inputrs} placeholder='RS' placeholderTextColor={"black"}
            ...
            onChangeText={(rs) => {
              ...
              setCash(rs)
              AsyncStorage.setItem('FRIENDLYBUSINESSCASH',cash)
            }} />
...
export default FriendlyBusiness