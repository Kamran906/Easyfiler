...
import CapitalAssets from './CapitalInfo'
      ...
      <View style={styles.innerView}>
        ...
        <View style={styles.lowerView}>
          <TopTab.Navigator screenOptions={{
            ...
            <TopTab.Screen name='Personal Information' component={CapitalAssets} />
            {/* <TopTab.Screen name='Employee Information' component={EmployeeInfo} /> */}
