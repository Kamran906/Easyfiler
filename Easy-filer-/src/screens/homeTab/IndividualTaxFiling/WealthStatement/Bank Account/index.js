        ...
        {isLoading || isLoader.isLoading ? (
          ...
          <><View style={Style.icntxtinput}>
            ...
            <Dropdown
              ...
              <TextInput style={[
                Style.placeholder1,
               {borderColor:accountNoError ? 'red':'grey'}
              ]}
                placeholder='Account/Instrument Number'
                placeholderTextColor={accountNoError ? 'red':"grey"}
                value={accountNo}
                onChangeText={text => [setAccountNo(text), setAccountNoError(false)]} />
                      ...
                      return (
                        <View style={Style.item}>
                          ...
                          <View style={Style.flatlisttxt}>
                            ...
                            <Text style={Style.modaltxt1}>Account No :   <Text style={Style.modaltxt2}>{item.account_no}</Text></Text>
