...
const TraderShop3 = () => {
  ...
  const { data, isError } = useGetTaxRatesQuery();
    ...
    <View style={Style.container}>
      {isLoading ?
        ...
        (
          <><ScrollView>
            ...
            <View style={Style.view2}>
              ...
              <TextInput style={[Style.placeholder2,{borderColor:taxDeductedError ? 'red':'grey'}]}
                ...
                placeholderTextColor={taxDeductedError ? 'red' : 'black'}
                value={taxDeducted}
            ...
            <View>
              ...
              <TextInput style={Style.placeholder3} keyboardType='numeric' placeholder='Amount'
                    ...
                    <View style={{ width: responsiveWidth(100) }}>
                      <View style={Style.bottomview}>
                        <View style={Style.icntxtinput2}>
                          {taxdata && (
                            <Dropdown
                              style={[Style.dropdown,{borderColor:adjustableRateError ? 'red':'grey'}]}
                              placeholderStyle={{
                                fontSize: Fonts.f14,
                                color: 'black',
          ...
          </ScrollView><Button onPressBack={() => navigation.navigate('TraderShop')}
