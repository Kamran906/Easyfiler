  ...
  return (
    <View style={Style.container}>
      <View style={Style.topview}>
        ...
        <Text style={Style.topviewtext1}><Text> deduction of withholding taxes </Text> by your client sat</Text>
        <Text style={Style.topviewtext1}>not the time of<Text> payment </Text> at all</Text>
      </View>
      ...
      <View style={Style.touchableview}>
        ...
        <TouchableOpacity style={Style.touchablebutton} onPress={()=> navigation.navigate('FreelancerNo1')}>
        <View>
       ...
       <View>
        ...
        <TouchableOpacity style={Style.touchablebutton2} onPress={()=> navigation.navigate('FreelancerNo2')}>
        <View>
        ...
        <TouchableOpacity style={Style.touchablebutton2} onPress={()=> navigation.navigate('FreelancerNo3')}>
        <View>
