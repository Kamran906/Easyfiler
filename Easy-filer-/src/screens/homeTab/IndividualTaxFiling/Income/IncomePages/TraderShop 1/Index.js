...
import { heights } from '../../../../../../assets/Styles/Height';
...
const TraderShop1 = () => {
  ...
  //Tax Rates api calling 
  const { data } = useGetTaxRatesQuery();
  ...
  // set id's in these varialbles
  const saveTaxRate = (id) => {
    dispatch(setTaxRateId(id))
  }
    ...
    axios
      ...
      .then((response) => {
        ...
        if (Object.keys(incomes).length > 0) {
          ...
          let rateid=lastIncomeData.taxrate_id
          let updatedId=rateid-1
          setTaxRate(data.tax_rates[updatedId])
        ...
        (
          ...
          <><ScrollView>
            ...
            <View style={Style.view2}>
              ...
              <TextInput style={[Style.placeholder2,{borderColor:taxDeductedError ? 'red':'grey'}]}
                keyboardType='numeric'
              ...
              <View style={Style.icntxtinput}>
                {data && (
                  <Dropdown
                    style={[Style.dropdown,{borderColor:taxRateError ? 'red':'grey'}]}
                    placeholderStyle={{
                      fontSize: Fonts.f14,
                      color: 'black',
                      color: taxRateError ? 'red' : 'grey',
                    ...
                    iconColor={taxRateError ? 'red':'grey'}
                    containerStyle={{
                      height: '30%',
                    ...
                    value={taxRate}
                    onChange={item => {
                      [setTaxRate(item.rate), saveTaxRate(item.id), setTaxRateError(false)];
                    }} />
                )}
                      ...
                      (
                        <View style={Style.hiddenview}>
                          <View style={Style.hiddenview1}>
                            ...
                            <TextInput style={[Style.innerplaceholder1,{borderColor:directExpenseError ? 'red':'grey'}]}
                             keyboardType='numeric'
                              placeholder='Amount'
                              placeholderTextColor={directExpenseError ? 'red' : 'grey'}
                              value={directExpense}
                              onChangeText={text => [setDirectExpense(text), setDirectExpenseError(false), setDirectExpenseError(false)]} />
                          </View>
                        </View>
                      )}
                        ...
                        <View style={Style.hiddenview}>
                          <View style={Style.hiddenview1}>
                            ...
                            <TextInput style={[Style.innerplaceholder1,{borderColor:indirectExpenseError ? 'red':'grey'}]} keyboardType='numeric'
                              placeholder='Amount'
                              placeholderTextColor={indirectExpenseError ? 'red' : 'grey'}
                      ...
                      (
                        <View style={{ width: responsiveWidth(100) }}>
                          <View style={{ marginTop: "3%", marginLeft: "5%" }}>
                            <Text style={{ color: "black", fontSize: Fonts.f18, fontFamily: FontFamily.OpenSansMedium }}>Assets</Text>
                            <Text style={{ color: "black", fontSize: Fonts.f16, marginTop: responsiveScreenHeight(1) }}>Other Assets</Text>
                            <TextInput style={[Style.innerplaceholder1,{borderColor:assetsError ? 'red':'grey'}]} keyboardType='numeric'
                              placeholder='Amount'
                              placeholderTextColor={assetsError ? 'red' : 'grey'}
                              value={assets}
                        ...
                        <View style={{ width: responsiveWidth(100) }}>
                          <View style={{ marginTop: "3%", marginLeft: "5%" }}>
                            ...
                            <TextInput style={[Style.innerplaceholder1,{borderColor:liabilityError ? 'red':'grey'}]} keyboardType='numeric'
                              placeholder='Amount'
                              placeholderTextColor={liabilityError ? 'red' : 'grey'}
                              value={liability}
                  ...
                  <View>
                    <View style={{ width: responsiveWidth(100) }}>
                      <View style={{ marginTop: "1%", marginLeft: "5%" }}>
                        <Text style={{ color: "black", fontSize: Fonts.f16, marginTop: responsiveScreenHeight(1), fontFamily: FontFamily.OpenSansMedium }}>Capital</Text>
                        <TextInput style={[Style.innerplaceholder1,{borderColor:capitalError ? 'red':'grey'}]} keyboardType='numeric'
                          placeholder='Amount'
                          placeholderTextColor={capitalError ? 'red' : 'grey'}
                          value={capital}
                    ...
                    <View style={{ width: responsiveWidth(100) }}>
                      <View style={{ flexDirection: "row", justifyContent: "center", marginTop: "3%" }}>
                          ...
                          {taxdata && (
                            <Dropdown
                              ...
                              placeholderStyle={{
                                fontSize: Fonts.f14,
                                color: 'black',
                                color: adjustableRateError ? 'red' : 'grey'
                        ...
                        <TextInput style={[Style.bottomplaceholder2,{borderColor:adjustableAmountError ? 'red':'grey'}]} keyboardType='numeric'
                          placeholder='Tax Deducted'
                          placeholderTextColor={adjustableAmountError ? 'red':'grey'}
