  ...
  return (
    <View style={Style.container}>
     <View style={Style.view1}>
      <Text style={Style.txt1}>Please select one of the options below regarding</Text>
      <Text style={Style.txt2}><Text style={Style.txt3}>deduction of withholding taxe</Text> by your client sat</Text>
      <Text  style={Style.txt2}>the time of payment</Text>
     </View>
