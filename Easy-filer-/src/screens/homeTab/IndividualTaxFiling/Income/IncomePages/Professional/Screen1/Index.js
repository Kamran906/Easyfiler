...
<ScrollView>
        ...
        <View style={Style.view2}>
          ...
          />
          <TextInput style={Style.placeholder2} keyboardType='numeric' placeholder='Tax Deducted'
            placeholderTextColor={"grey"}
          />
          <TextInput style={Style.placeholder2} textAlign={'center'} keyboardType='numeric' placeholder='Rates'
            placeholderTextColor={"grey"}
          />
        </View>
            ...
            (
              <View>
...

                {
                  ...
                  (
                    <View style={{width:responsiveWidth(100)}}>
                    <Text style={{color:"black",marginTop:"1%",marginLeft:"5%"}}>Assets</Text>
                    <View style={{flexDirection:"row",justifyContent:"space-evenly"}}>
                    <View>
                      <Text style={{color:"black",fontWeight:"400"}}>Plant/Machinery/Equipment</Text>
                      <TextInput style={Style.innerplaceholder1} keyboardType='numeric' placeholder='Amount'
                    placeholderTextColor={"grey"}
                  />
                      </View>
                      <View>
                      <Text style={{color:"black",fontWeight:"400"}}>Stock/store/spares</Text>
                     <TextInput style={Style.innerplaceholder1} keyboardType='numeric' placeholder='Amount'
                    placeholderTextColor={"grey"}
                  />
                  </View>
                    ...
                    <View style={{flexDirection:"row",justifyContent:"space-evenly",marginTop:"1%"}}>
                    <View>
                      <Text style={{color:"black",fontWeight:"400"}}>Advances/deposite</Text>
                      <TextInput style={Style.innerplaceholder1} keyboardType='numeric' placeholder='Amount'
                    placeholderTextColor={"grey"}
                  />
                      </View>
                      <View>
                      <Text style={{color:"black",fontWeight:"400"}}>Cash/Bank balance</Text>
                     <TextInput style={Style.innerplaceholder1} keyboardType='numeric' placeholder='Amount'
                    placeholderTextColor={"grey"}
                  />
                  </View>
                    ...
                    <View>
                      <Text style={{color:"black",fontWeight:"400"}}>Other Assets</Text>
                      <TextInput style={Style.innerplaceholder1} keyboardType='numeric' placeholder='Amount'
                    placeholderTextColor={"grey"}
                  />
                      </View>
            ...
            (
              <View>
              {
                ...
                (
                  <View style={{ width: responsiveWidth(100) }}>
                    <View style={{ marginTop: "3%", marginLeft: "5%" }}>
                      <Text style={{ color: "black", fontSize: 15, fontWeight: "bold" }}>Trade Creditors/Payable</Text>
                      <TextInput style={Style.innerplaceholder1} keyboardType='numeric' placeholder='Amount'
                        placeholderTextColor={"grey"}
                      />
                    </View>
...

              {
                ...
                (
                  ...
                  <View style={{flexDirection:"row",justifyContent:"space-evenly",marginTop:"1%"}}>
                  <View>
                    <Text style={{color:"black",fontWeight:"400"}}>Long term Borrowing debit loan</Text>
                ...
                />
                    ...
                    <View>
                    <Text style={{color:"black",fontWeight:"400"}}>Other liabilities</Text>
                   <TextInput style={Style.innerplaceholder2} keyboardType='numeric' placeholder='Amount'
                  placeholderTextColor={"grey"}
                />
                </View>
                  ...
                  <View>
                    <Text style={{color:"black",fontWeight:"400"}}>Trade</Text>
                    <TextInput style={Style.innerplaceholder1} keyboardType='numeric' placeholder='Amount'
                  placeholderTextColor={"grey"}
                />
                    </View>
