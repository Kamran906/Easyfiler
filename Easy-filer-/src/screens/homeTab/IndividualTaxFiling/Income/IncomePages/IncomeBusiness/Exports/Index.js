  ...
  return (
    <View style={Style.container}>
      <View style={Style.topview}>
        ...
        <Text style={Style.topviewtext2}><Text>deducted</Text> by your clients or some clients did <Text>not</Text></Text>
        <Text style={Style.topviewtext3}><Text>deducted</Text> at all</Text>
      </View>
